...
public class Blob {
    ...
    public static func create_from_buffer(repo: OpaquePointer, buffer: UnsafeRawPointer, len: Int) -> (Int32, git_oid) {
    ...
    public static func create_from_disk(repo: OpaquePointer, pathString: String) -> (Int32, git_oid) {
        let id = UnsafeMutablePointer<git_oid>.allocate(capacity: 1)
    ...
    public static func create_from_stream(repo: OpaquePointer, hintpathString: String) -> (Int32, git_writestream) {
    ...
    public static func create_from_stream_commit(stream: UnsafeMutablePointer<git_writestream>) -> (Int32, git_oid) {
        let id = UnsafeMutablePointer<git_oid>.allocate(capacity: 1)
        let error_code = git_blob_create_fromstream_commit(id, stream)
        return (error_code, id.pointee)
    }
    
    public static func create_from_workdir(repo: OpaquePointer, relativePathString: String) -> (Int32, git_oid) {
        let id = UnsafeMutablePointer<git_oid>.allocate(capacity: 1)
    ...
    public static func dup(source: OpaquePointer) -> (Int32, OpaquePointer?) {
